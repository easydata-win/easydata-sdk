...
const PATHS = {
  ...
  'sales.search.employees': '/sales/search/employees',
...
export class EasyData {
  ...
  readonly sales: {
    searchPeople: IOperationHandle;
    /** The people search across a list of companies, chunked. */
    searchEmployees: IOperationHandle;
    searchCompanies: IOperationHandle;
  };
  ...
  constructor(options: IClientOptions = {}) {
    ...
    this.sales = {
      ...
      searchEmployees: this.operation('sales.search.employees'),
